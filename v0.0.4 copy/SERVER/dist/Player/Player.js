...
import blockmap from '../World/blockdata';
...
class Player {
    constructor() {
        ...
        this.inventory = [[1, 99999], [2, 99999], [3, 99999], [4, 99999], [5, 99999], [6, 99999], [7, 99999], [8, 99999]]
        this.activeItem = 0;
    ...
    plant() {
        ...
        if (this.clickedElement.userData.objectType === 'Empty_Block') {
            ...
            this.clickedElement.userData.timeToGrow = 5000
